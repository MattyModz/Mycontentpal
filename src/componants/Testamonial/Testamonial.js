...
export default function Test() {
  return (
    <>
      <section class="flex items-center justify-center py-16 bg-white min-w-screen font-inter">
        <div class="max-w-6xl px-12 mx-auto bg-white md:px-16 xl:px-10">
          <div class="flex flex-col items-center lg:flex-row">
            <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
              ...
              <a
                href="#_"
                class="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-orange-400 border border-transparent rounded-md shadow hover:bg-orange-400 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo md:py-4 md:text-lg md:px-10"
              >
                View Case Studies
              </a>
            </div>
              ...
              >
                <div class="flex flex-col pr-10">
                  <div class="relative pl-12">
                    ...
                    <p class="mt-2 text-sm text-gray-600 sm:text-base lg:text-sm xl:text-base">
                      I needed terrific content that aligns with my client's
                      brand narrative, tone and market positioning
                      <br />
                      <br /> No other content provider understood that. But
                      Craig did.
                    </p>
                  </div>
                  ...
                  <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-gray-800 truncate sm:text-base lg:text-sm lg:text-base">
                    James Gregory
                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate"></span>
                  </h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img
